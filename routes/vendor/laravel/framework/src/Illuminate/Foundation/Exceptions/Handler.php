...
use Throwable;
use WeakMap;
// sandeep || add MethodNotAllowedHttpException
...
class Handler implements ExceptionHandlerContract
{
    ...
    public function render($request, Throwable $e)
    {
        ...
        // sandeep || add without token and wrong token error message 
        ...
        // Add handling for MethodNotAllowedHttpException
        if ($e instanceof MethodNotAllowedHttpException) {
            return response()->json([
                'message' => 'The requested method is not allowed for this route. Please check the documentation for supported methods.'
            ], 405);
        }

             // sandeep || add code route not found
            // Handle NotFoundHttpException for wrong routes
