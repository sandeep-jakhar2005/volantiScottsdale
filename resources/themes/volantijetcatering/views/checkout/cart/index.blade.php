                                    ...
                                    @foreach ($cart->items as $key => $item)
                                        ...
                                        <div class="row col-12">
                                            ...
                                            <div class="product-details-content col-6 pr0">
                                                ...
                                                <div class="row col-12">
                                                    @if(isset($item->additional['made-for']))
                                                    <div class="special-instruction">
                                                        <strong>Instructions:</strong>
                                                        {{ $item->additional['made_for'] }}
                                                    </div>
                                                    @endif 
                                                </div>
                                            </div>
                    ...
                    @else
                        <div class="row text-center w-100 empty__cart my-5">
                            <div class='image w-100'>
                                <img src="{{ asset('themes/volantijetcatering/assets/images/empty-cart.png') }}" class="img-fluid rounded-top" alt="">
                            </div>
                            ...
                            <a class="fs16 mt15 col-12 remove-decoration continue-shopping"
                                href="{{ route('shop.product.parentcat') }}">
