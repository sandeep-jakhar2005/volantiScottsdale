            ...
            Vue.component('checkout', {
                ...
                created: function() {
                    ...
                    if (!customerAddress) {
                        ...
                        this.address.billing.first_name = this.address.shipping.first_name = customerAddress
                            .first_name;
                        this.address.billing.last_name = this.address.shipping.last_name = customerAddress
                            .last_name;
                ...
                methods: {
                    ...
                    haveStates: function(addressType) {
                        if (this.countryStates[this.address[addressType].country] && this.countryStates[this
                    ...
                    saveAddress: async function() {
                        ...
                        this.$http.post("{{ route('shop.checkout.save_address') }}", this.address)
                            .then(response => {
                                ...
                                this.completed_step = this.step_numbers[response.data.jump_to_section] +
                                    1;
