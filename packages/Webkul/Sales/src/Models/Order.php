...
class Order extends Model implements OrderContract
{
    ...
    public const STATUS_INVOICE_SENT = 'invoice sent';
    ...
    public const STATUS_ORDER_SAVED = 'order saved';
    ...
    public const STATUS_FRAUD = 'fraud';
        ...
        // sandeep || add paid to deliverd  status
        // public const STATUS_PENDING = 'pending';
...
//    old data 
    protected $statusLabel = [
        ...
        self::STATUS_ORDER_SAVED     => 'order saved',
     ...
     // sandeep || add paid to delivered status
    // protected $statusLabel = [
    //     self::STATUS_PAID            => 'paid',
    //     self::STATUS_ACCEPTED        => 'accepted',
    //     self::STATUS_INVOICE_SENT    => 'invoice sent',
    ...
    // sandeep || add relation with order notes table
    ...
    public function canCancel(): bool
    {
        ...
        if (
            $this->payment->method == 'mpauthorizenet'
            && core()->getConfigData('sales.paymentmethods.cashondelivery.generate_invoice')
        ) {
            return true;
        }
