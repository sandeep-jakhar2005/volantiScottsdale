...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            // added for fbo in orders
            $table->string('fbo_full_name',256)->nullable();
            $table->string('fbo_phone_number',15)->nullable();
            $table->string('fbo_email_address',50)->nullable();
            $table->string('fbo_tail_number',50)->nullable();
            $table->string('fbo_packaging',55)->nullable();
