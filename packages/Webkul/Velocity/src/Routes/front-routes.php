...
Route::group(['middleware' => ['locale', 'theme', 'currency']], function () {
    ...
    Route::group(['middleware' => ['cart.merger']], function () {
        ...
        Route::get('category-search', [ShopController::class, 'search'])
        ...
        Route::get('category-details', [ShopController::class, 'categoryDetails'])
            ...
            Route::get('category-products/{categoryId}', [ShopController::class, 'getCategorydetail'])
                ->name('velocity.category.products');
            Route::get('search/category-products/{categoryId}', [ShopController::class, 'getCategorydetail'])
