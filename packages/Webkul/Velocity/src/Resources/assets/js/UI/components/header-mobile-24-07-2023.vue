<template>
        <div class="row">
            <div class="mobile-screen-header-col-1">
                ...
                <div class="hamburger-wrapper ram1" @click="toggleHamburger">
            ...
            <div class="right-vc-header mobile-screen-header-col-3">
                ...
                <a :href="cartRoute" class="unset">
                   <!-- <i class="material-icons text-down-3">shopping_cart</i> -->
                    <i class="material-icons text-down-3 mobile-bag-icon"><img src="http://127.0.0.1:8000/themes/velocity/assets/images/shopping-bag-icon.png" ></i>
