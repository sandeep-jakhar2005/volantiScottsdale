...
<div class="account-content">   
    ...
    <div class="account-layout">
        ...
        <div class="account-head">
            ...
            <span class="account-heading">{{ __('mpauthorizenet::app.customer.account.savecard.index.title') }}</span>

            <span class="account-action">
                <a id="add-new-card" style="cursor: pointer;">{{ __('mpauthorizenet::app.customer.account.savecard.index.add') }}</a>    
            </span>
