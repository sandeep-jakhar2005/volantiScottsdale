...
class ProductController extends Controller
{
    ...
    // {
    //  $alsolike =  DB::table('product_flat')
    // ->select('product_flat.name', 'product_flat.price')
    // ->join('product_category', 'product_flat.product_id', '=', 'product_category.product_id')
    // ->join('product_image', 'product_flat.product_id', '=', 'product_image.product_id')
    // ->where('product_category.category_id', 22)
    // ->where('product_image.category_id', 22)
    // ->get();

    // return view('volantijetcatering.products.view',['dataz'=> $alsolike]);
    // }
}
