...
use Webkul\Customer\Notifications\ApiCustomerResetPassword;
...
{
    return $this->hasMany(OrderNotes::class, 'customer_id'); 
}
    ...
    public function apiSendPasswordResetNotification($token): void
    {
      
        $this->notify(new ApiCustomerResetPassword($token));
    }
