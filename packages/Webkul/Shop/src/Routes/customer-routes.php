...
// sandeep customazation controller
...
Route::group(['middleware' => ['locale', 'theme', 'currency']], function () {
    ...
    Route::group(['middleware' => ['cart.merger']], function () {
        Route::prefix('customer')->group(function () {
            ...
            /* api forget passsword route*/
            Route::get('/api-reset-password/{token}', [ResetPasswordController::class, 'create'])->defaults('_config', [
                'view' => 'shop::customers.signup.api-reset-password',
            ])->name('shop.customer.reset_password.api-create');
            ...
            Route::group(['middleware' => ['customer']], function () {
                ...
                Route::prefix('account')->group(function () {
                     ...
                     * Addresses.
                     */
                    Route::get('addresses', [CheckoutController::class, 'show_fbo_detail'])->defaults('_config', [
