<template>
    <div>
      ...
      > -->
        <ul class="dropdown-container" v-on:keyup.enter="getResponse">
            ...
            <li v-if="types.string.isSelected">
                <div class="control-group">
                    <select class="control" v-model="types.string.condition">
                        <option
            ...
            <li v-if="types.number.isSelected">
                <div class="control-group">
                    <select class="control" v-model="types.number.condition">
                        <option
                            v-text="translations.condition"
                            selected
                            value="null"
            ...
            <li v-if="types.boolean.isSelected">
                <div class="control-group">
                    <select class="control" v-model="types.boolean.condition">
                        <option
                            v-text="translations.condition"
                            selected
                            value="null"
            ...
            <li v-if="types.dropdown.isSelected">
                <div class="control-group">
                    <select class="control" v-model="types.dropdown.condition">
                        <option
                            v-text="translations.condition"
                            selected
                            value="null"
                ...
                <div class="control-group">
                    <select class="control" v-model="types.dropdown.value">
                        <option
                            ...
                            v-for="(
                                option, key
                            ) in this.getCurrentFilterOptions()"
                        ></option>
                    </select>
                </div>
            </li>
            ...
            <li v-if="types.checkbox.isSelected">
                <div class="control-group">
                    <select class="control" v-model="types.checkbox.condition">
                        <option
                            v-text="translations.condition"
                            selected
                            value="null"
            ...
            <li v-if="types.checkbox.condition != null">
                <div class="control-group status_filter">
                    <button
                        style="width: 100%"
                        type="button"
                        class="dropdown-btn status_filter_button dropdown-toggle"
                        @click="toggleCheckboxDropdown(false)"
                    >
                        <span>
                            {{
            ...
            <li v-if="types.datetime.isSelected">
                <div class="control-group">
                    <select class="control" v-model="types.datetime.condition">
                        <option
                            v-text="translations.condition"
                            selected
                            value="null"
...
export default {
    ...
    methods: {
        ...
        emitOnFilterEvent(type, label, isEncoded = false) {
            console.log("columnOrAlias:", this.columnOrAlias);
            this.$emit("onFilter", {
                data: {
