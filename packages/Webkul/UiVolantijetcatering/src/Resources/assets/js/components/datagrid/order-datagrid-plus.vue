    ...
    <div class="table" v-if="isDataLoaded" :key="dataGridIndex">
        <div class="grid-container">
            <div class="grid-top">
                ...
                <div
                    class="datagrid-filters order__datagrid__filter"
                    id="datagrid-filters"
                >
...
<script>
import OrderColumnFilter from "./filters/order-column-filter";
        ...
        makeURL() {
            ...
            for (let i = 0; i < this.filters.length; i++) {
                ...
                url.searchParams.set(
                    `${this.filters[i].column}${condition}`,
                    this.filters[i].val
                );
            }
            ...
            if (this.extraFilters) {
                url.searchParams.set(
                    "channel",
                    this.extraFilters.current.channel
                );
                url.searchParams.set(
                    "locale",
                    this.extraFilters.current.locale
                );
            }
