<!-- <div class="layered-filter-wrapper left">
    ...
    <layered-navigation
        attribute-src="<?php echo e(route('shop.catalog.categories.filterable_attributes', $category->id ?? null)); ?>"
        max-price-src="<?php echo e(route('shop.catalog.categories.maximum_price', $category->id ?? null)); ?>">
    </layered-navigation>

    <?php echo view_render_event('bagisto.shop.products.list.layered-nagigation.after'); ?>

</div> -->
<!-- comment out by shyam 25-07-2023 -->
            ...
            <div class="filter-attributes-content">
                ...
                <div class="price-range-wrapper" v-if="attribute.type == 'price'">
                    ...
                    <div class="filter-input row col-12 no-padding">
                        ...
                        <label class="col text-center" for="to"><?php echo e(__('shop::app.products.filter-to')); ?></label>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\sandeep-projects\VolantiScottsdale/resources/themes/volantijetcatering/views/products/list/layered-navigation.blade.php ENDPATH**/ ?>