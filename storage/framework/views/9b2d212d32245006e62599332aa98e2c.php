    ...
    <div class="contact-us-container container mt-5  pl-2 pr-2 pl-lg-5 pr-lg-5 pl-md-5 pr-md-5">
        <div class="row pl-3 pr-3 pl-lg-5 pr-lg-5">
            ...
            <div class="col-lg-8 mb-5 contact-us-form p-0">
                ...
                <img src="<?php echo e(asset('themes/volantijetcatering/assets/images/message-icon.png')); ?>" alt="Email Icon" height="30px" width="30px" class="ml-auto pr-1"/>
            </span>
            ...
            <div class="col-lg-4 contact-email-details pl-lg-4 pr-lg-4 pl-1 pr-1 mb-5">
                <div class="contact-email-section">
                    <span class="d-flex align-items-center contact-details-section">
                        ...
                        <img src="<?php echo e(asset('themes/volantijetcatering/assets/images/call.png')); ?>" alt="Email Icon" height="30px" width="30px" class="ml-auto pr-1"/>
                    </span>
...
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sandeep-projects\VolantiScottsdale\packages\Webkul\RKREZA\Contact\src\Providers/../Resources/views/contact/shop/index.blade.php ENDPATH**/ ?>