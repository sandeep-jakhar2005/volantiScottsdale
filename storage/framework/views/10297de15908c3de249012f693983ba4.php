    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            ...
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                <?php echo e(__('shop::app.mail.order.dear', ['customer_name' => $admin_name])); ?>,
            </p>
                    ...
                    <tbody> 
                        <?php $__currentLoopData = $order['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php endif; ?>
                                ...
                                <?php
                                 \Log::info('Item name:', ['name' => $item['name']]);
                                \Log::info('Special Instruction:', ['instruction' => $item['additional']['special_instruction']]);
                            ?>
...
<?php /**PATH C:\xampp\htdocs\sandeep-projects\VolantiScottsdale\resources\views/mail/admin-order-notify.blade.php ENDPATH**/ ?>