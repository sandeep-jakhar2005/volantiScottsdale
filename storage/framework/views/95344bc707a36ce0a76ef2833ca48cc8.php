        ...
        <div class="coupon-container">
                ...
                <form class="custom-form" method="post" @submit.prevent="applyCoupon">
                    <div class="control-group" :class="[errorMessage ? 'has-error' : '']">
                        <input
                            ...
                            class="control"
                            v-model="couponCode"
                            placeholder="<?php echo e(__('shop::app.checkout.onepage.enter-coupon-code')); ?>" />

                        <div class="control-error">{{ errorMessage }}</div>
                    </div>

                    <button class="theme-btn light" :disabled="disableButton"><?php echo e(__('shop::app.checkout.onepage.apply-coupon')); ?></button>
                </form>
            </div>
            ...
            <div class="applied-coupon-details" v-if="appliedCoupon">
                ...
                <label class="right" style="display: inline-flex; align-items: center;">
                    ...
                    <i class="rango-close fs18" title="<?php echo e(__('shop::app.checkout.total.remove-coupon')); ?>" v-on:click="removeCoupon"></i>
                </label>
            </div>
        </div>
    </script>
        ...
        Vue.component('coupon-component', {
            ...
            data: function() {
                return {
                    couponCode: '',
                    errorMessage: '',
                    appliedCoupon: "<?php echo e($cart->coupon_code); ?>",
                    routeName: "<?php echo e(request()->route()->getName()); ?>",
                    disableButton: false,
            ...
            methods: {
                applyCoupon: function() {
                    if (! this.couponCode.length) {
                        this.errorMessage = '<?php echo e(__('shop::app.checkout.total.invalid-coupon')); ?>';
                    ...
                    axios
                        .post(
                            '<?php echo e(route('shop.checkout.cart.coupon.apply')); ?>', {code}
                        ).then(response => {
                ...
                removeCoupon: function () {
                    ...
                    if (self.removeIconEnabled) {
                        ...
                        axios
                        .delete('<?php echo e(route('shop.checkout.coupon.remove.coupon')); ?>')
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\sandeep-projects\VolantiScottsdale/resources/themes/volantijetcatering/views/checkout/cart/coupon.blade.php ENDPATH**/ ?>