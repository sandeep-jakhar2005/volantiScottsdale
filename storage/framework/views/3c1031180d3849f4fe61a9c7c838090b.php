...
<?php if(
    ...
    <?php $__env->startSection('content-wrapper'); ?>
        <div class="container fbo-detail">
            <h1 class="fs24 fw6 text-center  fbo-head"><?php echo e(__('shop::app.fbo-detail.client-info')); ?></h1>
            <div class="col-lg-10 col-md-12 offset-lg-1 mt-5">
                <div class="body col-12 border-0 p-0">
                    <form action="<?php echo e(route('cateringpackage.shop.customer.add-fbo')); ?>" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="control-group col-sm-12 col-md-6 mb-3"
                                ...
                                <input type="text" class="form-control form-control-lg"
                                    value="<?php echo e(isset($fboDetails->full_name) && $fboDetails->full_name ? $fboDetails->full_name : (auth('customer')->check() ? trim(auth('customer')->user()->first_name . ' ' . auth('customer')->user()->last_name) : '')); ?>"
                            ...
                            <div class="control-group col-sm-12 col-md-6 mb-3"
                                ...
                                <input type="email" class="form-control form-control-lg"
                                    value="<?php echo e(isset($fboDetails->email_address) && $fboDetails->email_address ? $fboDetails->email_address : (auth('customer')->check() && auth('customer')->user()->email ? auth('customer')->user()->email : '')); ?>"
                        ...
                        <h1 class="fs24 fw6 text-center  my-5"><?php echo e(__('shop::app.fbo-detail.aircraft-info')); ?></h1>
                        <div class="row">
                            <div class="control-group col-sm-12 col-md-6 mb-3"
                                ...
                                <input type="text" class="control form-control form-control-lg"
                                    value="<?php echo e(isset($fboDetails->tail_number) ? $fboDetails->tail_number : ''); ?>"
                                ...
                                <div class="custom-dropdown ">
                                    <select class="form-control form-control-lg" name="packagingsection"
                                        ...
                                        <option value="Microwave"
                                            <?php echo e(isset($fboDetails->packaging_section) && $fboDetails->packaging_section == 'Microwave' ? 'selected' : ''); ?>>
                                            Microwave</option>
                                        <option value="Oven"
                                            <?php echo e(isset($fboDetails->packaging_section) && $fboDetails->packaging_section == 'Oven' ? 'selected' : ''); ?>>
                                            Oven</option>
                                        <option value="Both"
                                            <?php echo e(isset($fboDetails->packaging_section) && $fboDetails->packaging_section == 'Both' ? 'selected' : ''); ?>>
                                            Both</option>
                                    </select>
                                </div>
                                ...
                                <div class="custom-dropdown ">
                                    <select class="form-control form-control-lg" name="servicepackaging"
                                        ...
                                        <option value="Bulk Packaging"
                                            <?php echo e(isset($fboDetails->service_packaging) && $fboDetails->service_packaging == 'Bulk Packaging' ? 'selected' : ''); ?>>
                                            Bulk Packaging</option>
                                        <option value="Ready For Services"
                                            <?php echo e(isset($fboDetails->service_packaging) && $fboDetails->service_packaging == 'Ready For Services' ? 'selected' : ''); ?>>
                        ...
                        <?php if(isset($fboDetails)): ?>
                            <?php if(!isset($fboDetails->delivery_date) && !isset($fboDetails->delivery_time)): ?>
                        ...
                        <div class="row">
                            <div class="control-group col-sm-12 col-md-6 mb-3"
                                ...
                                <label for="delivery_date" class="required label-style mandatory text-left">
                                    <?php echo e(__('shop::app.fbo-detail.delivery_date')); ?>

                                </label>

                                <input type="text" required readonly class="form-control form-control-lg" id="daySelect"
                                    value="<?php echo e(isset($formattedDate) ? $formattedDate : ''); ?>" v-validate="'required'"
                            ...
                            <div class="control-group col-sm-12 col-md-6 mb-3"
                                ...
                                <label for="delivery_time" class="required label-style mandatory text-left">
                                    <?php echo e(__('shop::app.fbo-detail.delivery_time')); ?>

                                </label>

                                <input type="text" required readonly id="timeSlots"
                                    class="form-control form-control-lg"
                                    value="<?php echo e(isset($fboDetails->delivery_time) ? $fboDetails->delivery_time : ''); ?>"
...
<?php else: ?>
    ...
    <div class="container">
        <div id="checkout" class="checkout-process row offset-lg-1 col-lg-11 col-md-12">
            <h1 class="col-12 text-center my-4"><?php echo e(__('velocity::app.checkout.checkout')); ?></h1>
            <div class="col-lg-4 col-md-6 col-12 border checkout-left">
                <div class="step-content information" id="address-section">
                    <?php echo $__env->make('shop::checkout.onepage.customer-info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                    ...
                    <div class="row border-top">
                            <div class="border-0" style="width: 100%;">
                                <div class="card-body fbo-body"> 
                                    ...
                                    <div class='row mt-4'>
                                        <div class='col-9'><h4 class="card-title fw6"><?php echo e(__('shop::app.fbo-detail.client-info')); ?></h4></div>
                                        <div class='col-3 fbo-edit text-right'><span class="text-danger pointer" data-toggle="modal" data-target="#fboModal">edit</span></div>
                                            <div class='fbo-body px-3'>
                                                <h6 class="card-subtitle mb-2"><?php echo e($fboDetails->full_name); ?> </h6>
                                                <h6><?php echo e($fboDetails->email_address); ?></h6>
                                                <h6><?php echo e($fboDetails->phone_number); ?></h6>
                                                
                                            </div>
                                    </div>   
                                    <div class='row mt-2'>
                                        <div class='col-9'><h5 class="card-title child-card-title fw6"><?php echo e(__('shop::app.fbo-detail.aircraft-info')); ?></h5></div>
                                            <div class='fbo-body px-3'>
                                                <h6><?php echo e($fboDetails->tail_number); ?></h6>
                                                <h6><?php echo e($fboDetails->packaging_section); ?></h6>
                                                <h6><?php echo e($fboDetails->service_packaging); ?></h6>
                                            </div>
                                     </div>
                                    <div class='row mt-2'>
                                        <div class='col-9'><h5 class="card-title child-card-title fw6">Delivery Time</h5></div>
                                            <div class='fbo-body px-3'>
                                                ...
                                                <h6><?php echo e(date('m-d-Y', strtotime( $fboDetails->delivery_date))); ?></h6>
                                                <h6><?php echo e($fboDetails->delivery_time); ?></h6>
                                            </div>
                                    </div>   
                                </div>   
                            </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-header fbo-header align-items-center">
                            <h1 class="fs24 fw6 pl-2 m-0">
                                <?php echo e(__('shop::app.fbo-detail.aircraft-info')); ?>
                        ...
                        <div class="modal-body popup-content">
                                <div class="body col-12 border-0 p-3">
                                    <form action="<?php echo e(route('cateringpackage.shop.customer.update-fbo')); ?>" method="POST"
                                        >
                                        <?php echo e(csrf_field()); ?>

                                        <div class="row mb-3">
                                            <div class="col-12 text-center">
                                                <h1 class="fs24 fw6"><?php echo e(__('shop::app.fbo-detail.client-info')); ?></h1>
                                            </div>
                                            <div class="control-group col-sm-12 col-md-6 col-lg-6 mb-3" :class="[errors.has('fullname') ? 'has-error' : '']">
                                                ...
                                                <input type="text" class="form-control form-control-lg" value="<?php echo e($fboDetails->full_name); ?>"
                                                    v-validate="'required'" name='fullname' />
                                            ...
                                            <div class="control-group col-sm-12 col-md-6 col-lg-6 mb-3" :class="[errors.has('phonenumber') ? 'has-error' : '']">
                                                ...
                                                <input type="Number" class="form-control form-control-lg" value="<?php echo e($fboDetails->phone_number); ?>"
                                                    name="phonenumber" v-validate="'required|numeric|min:10|max:12'" />
                                            ...
                                            <div class="control-group col-sm-12 col-md-6 col-lg-6 mb-3" :class="[errors.has('email') ? 'has-error' : '']">
                                                ...
                                                <input type="email" class="form-control form-control-lg" value="<?php echo e($fboDetails->email_address); ?>"
                                                    name="email" v-validate="'required'" />
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12 text-center">
                                                <h1 class="fs24 fw6"><?php echo e(__('shop::app.fbo-detail.aircraft-info')); ?></h1>
                                            </div>
                                            <div class="control-group col-sm-12 col-md-6 col-lg-6 mb-3" :class="[errors.has('tailnumber') ? 'has-error' : '']">
                                                ...
                                                <input type="text" class="control form-control form-control-lg" value="<?php echo e($fboDetails->tail_number); ?>" name="tailnumber"
                                                    v-validate="'required'">
                                                <span class="control-error" v-if="errors.has('tailnumber')"
                                ...
                                <div class="custom-dropdown">
                                    <select class="form-control form-control-lg" name="packagingsection" v-validate="'required'">
                                        <option value="" disabled>Select Packaging</option>
                                        <option value="Microwave" <?php echo e($fboDetails->packaging_section == 'Microwave' ? 'selected' : ''); ?>>Microwave</option>
                                        <option value="Oven" <?php echo e($fboDetails->packaging_section == 'Oven' ? 'selected' : ''); ?>>Oven</option>
                                        <option value="Both" <?php echo e($fboDetails->packaging_section == 'Both' ? 'selected' : ''); ?>>Both</option>
                                    </select>
                                </div>
                                <span class="control-error" v-if="errors.has('packagingsection')"
                                    v-text="'The packaging section field is required'"></span>
                                            ...
                                            <div class="control-group col-sm-12 col-md-6 mb-3 servicepackaging"
                                                ...
                                                <div class="custom-dropdown">
                                                    <select class="form-control form-control-lg" name="servicepackaging" v-validate="'required'">
                                                        <option value="" disabled>Select Packaging</option>
                                                        <option value="Bulk Packaging" <?php echo e($fboDetails->service_packaging == 'Bulk Packaging' ? 'selected' : ''); ?>>Bulk Packaging</option>
                                                        <option value="Ready For Services" <?php echo e($fboDetails->service_packaging == 'Ready For Services' ? 'selected' : ''); ?>>Ready For Services</option>
                                                    </select>
                                                </div>
                                                <span class="control-error" v-if="errors.has('servicepackaging')"
                                                    v-text="'The packaging section field is required'"></span>
                                        ...
                                        <div class="row">
                                            <div class="control-group col-sm-12 col-md-6 col-lg-6 mb-3" :class="[errors.has('delivery_date') ? 'has-error' : '']">
                                                ...
                                                <input type="text" readonly id="daySelect" class="control form-control form-control-lg" value="<?php echo e($formattedDate); ?>" name="delivery_date"
                                                    v-validate="'required'">
                                                    <div class="delivery_select  delivery_select_date">
                                                        <ul id="dayList"></ul>
                                                    </div>
                                            ...
                                            <div class="control-group col-sm-12 col-md-6 col-lg-6 mb-3" :class="[errors.has('delivery_date') ? 'has-error' : '']">
                                                ...
                                                <input type="text"  id="timeSlots" readonly class="control form-control form-control-lg" value="<?php echo e($fboDetails->delivery_time); ?>" name="delivery_time"
                                                    v-validate="'required'">
                                                    <div class="delivery_select delivery_select_time">
                                                        <ul id="timeSlotsList"></ul>
                                                    </div>
                            ...
                            <ol class='summary-body'>
                              ...
                              ?>
                                <li>
                                    <div class='row mx-1'>
                                        <div class='col-8'>
                                            <h6 class="items"><?php echo e($cartItem->name); ?></h6>
                                            <?php if(isset($optionLabel) ): ?>
                                            <p class="checkout__options" style="font-size:13px"><strong>Preference: </strong><span><?php echo e($optionLabel); ?></span> </p>
                                            <?php endif; ?>
                                        </div>
                                        <div class='col-4 text-right'>
                                            <p><strong>Qty: </strong><?php echo e($cartItem->quantity); ?></p>
                                        </div>
                                        <div class='col-12' style='margin-top: -10px;font-size:13px'>
                                            <?php if(isset($cartItem->additional['special_instruction']) && $cartItem->additional['special_instruction']!='' ): ?>
                                            <p style='margin-top: -17px' class="special-intruction"><strong>Special Instruction: </strong> <span><?php echo e($cartItem->additional['special_instruction']); ?></span></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </li>  
            ...
            (() => {
                    ...
                    <?php if(auth()->guard('customer')->check()): ?>
                        ...
                        <?php if(auth('customer')->user()->addresses): ?>
                            customerAddress = <?php echo json_encode($addresses, 15, 512) ?>;
                    ...
                    Vue.component('checkout', {
                            ...
                            methods: {
                                ...
                                fetchCountries: function() {
                                    ...
                                    let countriesEndPoint = '<?php echo e(route('shop.countries')); ?>';
                                ...
                                fetchCountryStates: function() {
                                    let countryStateEndPoint = '<?php echo e(route('shop.countries.states')); ?>';
                                ...
                                saveShipping: async function() {
                                    ...
                                    this.$http.post("<?php echo e(route('shop.checkout.save_shipping')); ?>", {
                                ...
                                isCustomerExist: function() {
                                    ...
                                    this.$validator.validate('address-form.billing[email]', this.address.billing
                                        ...
                                        .then(isValid => {
                                            ...
                                            this.$http.post("<?php echo e(route('shop.customer.checkout.exist')); ?>", {
                                ...
                                loginCustomer: function() {
                                    this.$http.post("<?php echo e(route('shop.customer.checkout.login')); ?>", {
                                            email: this.address.billing.email,
                                        ...
                                        .then(response => {
                                            if (response.data.success) {
                                                window.location.href =
                                                    "<?php echo e(route('shop.checkout.onepage.show_fbo_detail')); ?>";
                                            } else {
                                ...
                                saveAddress: async function() {
                                    ...
                                    this.$http.post("<?php echo e(route('shop.checkout.save_address')); ?>", this.address)
                                        .then(response => {
                                ...
                                savePayment: async function() {
                                    ...
                                    if (this.isCheckPayment) {
                                        ...
                                        this.$http.post("<?php echo e(route('shop.checkout.save_payment')); ?>", {
                                                'payment': this.selected_payment_method
                                            })
                                            .then(response => {
                                ...
                                if (this.isPlaceOrderEnabled) {
                                    ...
                                    this.$http.post("<?php echo e(route('shop.checkout.save_order')); ?>", {
                                        ...
                                        .then(response => {
                                            if (response.data.success) {
                                                if (response.data.redirect_url) {
                                                    ...
                                                    this.$root.hideLoader();
                                                    window.location.href =
                                                        "<?php echo e(route('shop.checkout.success')); ?>";
                                                }
                                            }
                                        })
                                        .catch(error => {
...
<?php echo $__env->make('shop::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sandeep-projects\VolantiScottsdale\packages\ACME\CateringPackage\src\Providers/../Resources/views/shop/volantijetcatering/customer/checkout.blade.php ENDPATH**/ ?>