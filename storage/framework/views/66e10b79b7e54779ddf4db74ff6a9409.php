    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            ...
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                <?php echo e(__('shop::app.mail.order.dear', ['customer_name' => $order['customer_first_name'] == '' ? $fullName : $order['customer_first_name']])); ?>,
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                <?php echo __('shop::app.mail.order.order_greeting', [
                    'order_id' =>
                        '<a href="' .
                        ...
                        $order['increment_id'] .
                        '</a>',
                    'created_at' => core()->formatDate($order['created_at'], 'm-d-Y H:i:s'),
                ]); ?>
            ...
            <?php if(isset($order['shipping_address'])): ?>
                <div style="line-height: 25px;">
                    ...
                    <div style="margin-bottom: 40px;">
                        <?php echo e(__('shop::app.mail.order.contact')); ?> : <?php echo e($order['fbo_phone_number']); ?>
...
<?php /**PATH C:\xampp\htdocs\sandeep-projects\VolantiScottsdale\resources\views/mail/guest-new-order.blade.php ENDPATH**/ ?>